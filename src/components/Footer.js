                ...
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
                    ...
                    <div className="col-span-12 lg:col-span-4">
                        <div className="box-border border-b-4 border-blue-900 p-8 bg-gray-200 text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                            <h3 className="font-bold text-4xl mb-4">Red Hood Software Inc.</h3>
                            <div className='text-md font-medium text-gray-600'>
                                <h5>주식회사 레드후드소프트웨어</h5>
                                <p>벤처창업관 404호</p>
                                <p>국립금오공과대학교</p>
                                <p>경북 구미시 대학로 61</p>
                            </div>
                    ...
                    <div className="col-span-6 md:col-span-6 lg:col-span-1 ml-7 mx-auto">
                        ...
                        <li className="mb-2">
                            <HashLink to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">회사 소개</HashLink>
                        </li>
                        <li className="mb-2">
                            <HashLink to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">서비스 소개</HashLink>
                        </li>
                        <li className="mb-2">
                    ...
                    <div className="col-span-6 md:col-span-6 lg:col-span-4 mx-auto">
                        <h6 className="text-[#013289] text-xl font-bold mb-4">우리 서비스</h6>
                        <ul className="text-md">
                        <li className="mb-2">
